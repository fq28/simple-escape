<script lang="ts">
  ...
  type EvidenceItem = {
    ...
    active: boolean;    // if false → “coming soon” card
    rewardText?: string;
    emoji: string;   // 👈 this will now BE the image
  };
...

{
  ...
  description:
    'Dit geluidsfragment werd in het dossier als “onbruikbaar” bestempeld wegens zware ruis. Jullie onderzoeken of er toch verstaanbare informatie in verborgen zit.',
  prompt:
  ...
  active: true,
  rewardText:
    'Door de audiokanalen te scheiden, blijkt de getuigenverklaring alsnog hoorbaar. De zin “hij heeft nog nooit een vlieg kwaad gedaan” zet de zaak tegen Jeremy Bowers verder onder druk. Dit bewijsstuk wordt voorlopig als relevant beschouwd.'
},
